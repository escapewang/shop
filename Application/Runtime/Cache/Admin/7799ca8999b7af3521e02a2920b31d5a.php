            ...
            <table class="table_a" border="1" width="100%">
               ...
               <td>可选值列表</td>
                    ...
                    <?php if(is_array($datas)): foreach($datas as $key=>$val): ?><tr id="product1">
                        ...
                        <td><?php echo (getAttr($val["attr_type"])); ?></td>
                        <!-- <td> 手工录入 从列表中选择</td> -->
            <td> <?php echo (getInsertAttr($val["attr_insert_type"])); ?></td>
                        <td><?php echo ($val["attr_value"]); ?></td>
    ...
    <script type="text/javascript">
        ...
        function del(id){
            if(confirm('是否确认删除？')){
                ...
                window.location.href='/Admin/Attribute/category_del/id/'+id;
            }
