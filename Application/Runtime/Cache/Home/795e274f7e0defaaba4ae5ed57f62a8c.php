...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body class="index_body">
        ...
        <div class="header_bg_b">
         ...
         <!-- 引入放大镜需要的文件 1-->
        <link rel="stylesheet" type="text/css" href="/Public/magnify/css/zzsc.css">

        <script type="text/javascript" class="library" src="/Public/magnify/js/jquery-1.8.2.min.js"></script>
        <script type="text/javascript" class="library" src="/Public/magnify/js/jquery.colorbox-min.js"></script>
        <script  class="library" src="/Public/magnify/js/zzsc.js"></script>
        <!-- /1 -->
            ...
            <div class="AreaR">
                ...
                <div class="con-FangDa" id="fangdajing">
                  <div class="con-fangDaIMg">
                    <!-- 正常显示的图片-->
                    <img src="/Public/Upload/goods/<?php echo ($data["goods_big_img"]); ?>" height="310px" width="310px;">
                    <!-- 滑块-->  
                  ...
                  <ul class="con-FangDa-ImgList">
                    <li><img src="/Public/Upload/goods/<?php echo ($data["goods_thumb_img"]); ?>" data-bigimg="/Public/Upload/goods/<?php echo ($data["goods_big_img"]); ?>" width="35px"></li>
                    <!-- 图片显示列表 -->
                    <?php if(is_array($imgdatas)): foreach($imgdatas as $key=>$val): ?><li><img src="/Public/Upload/goods/<?php echo ($val["thumb_img"]); ?>" data-bigimg="/Public/Upload/goods/<?php echo ($val["big_img"]); ?>" width="35px"></li><?php endforeach; endif; ?>
                    ...
                    <div class="textInfo">
                        <form action="<?php echo U('carts/add');?>" method="post" name="ECS_FORMBUY" id="carts_form">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        ...
                                        <strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE"><?php echo ($data["goods_price"]); ?></font><br />
                                ...
                                <?php if(is_array($attrdatas)): foreach($attrdatas as $key=>$d): ?><li class="padd loop">
                                    <strong><?php echo ($d["attr_name"]); ?>:</strong>
                                    <?php if($d["attr_type"] == 2): if(is_array($d["goods_attr_value"])): foreach($d["goods_attr_value"] as $key=>$dd): ?><label for="spec_value_227">
                                        <input name="val[<?php echo ($d["attr_name"]); ?>]" value="<?php echo ($dd); ?>" id="spec_value_227" checked="checked" onclick="changePrice()" type="radio" />
                                        <?php echo ($dd); ?></label><?php endforeach; endif; ?>
                                    <?php else: ?>
                                    <?php echo ($d["goods_attr_value"]); endif; ?>
                                ...
                                <li class="padd">
                                    ...
                                    <a href="javascript:void(0)"><img src="/Public/Home/images/shoucang2.gif" id="shoucang"></a>
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <form name="tagForm"   id="tagForm">
                                ...
                                <p>
                                    ...
                                    <input name="goods" value="9" type="hidden" />
                                </p>
                            </form>
                        </div>
                    </div>
