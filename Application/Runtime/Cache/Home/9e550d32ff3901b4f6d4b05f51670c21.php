   ...
   <!--   引入layer弹窗所需要的文件-->
                    ...
                    <table cellpadding="5" cellspacing="1">
                        <tbody><tr>
                            ...
                            <?php if(is_array($datas)): foreach($datas as $key=>$d): ?><tr>
                                ...
                                <td>
                                <?php if(is_array($d["val"])): foreach($d["val"] as $key=>$dd): echo ($key); ?>:<?php echo ($dd); ?> <br><?php endforeach; endif; ?>
                                </td>
                               
                                <td align="right">￥<?php echo ($d["goods_mprice"]); ?>元</td>
                                <td align="right">￥<span class="pri"><?php echo ($d["goods_price"]); ?></span>元</td>
                                <td align="right">
                                      <span class="nnn"> <a href="javascript:void(0)" class="mins">[-]</a>
                                   <input name="goods_number" id="goods_number" value="<?php echo ($d["goods_number"]); ?>" size="4" class="inputBg" style="text-align: center;" onkeydown="showdiv(this)" type="text" data-id="<?php echo ($d["goods_id"]); ?>"/>
                                    <a href="javascript:void(0)" class="plus">[+]</a></span>
                                  
                                </td>
                                <td align="right">￥<span class="money"><?php echo getMoney($d[goods_price],$d[goods_number]); ?></span>元</td>
                                <td align="center">
                                    <a href="javascript:void(0)" class="del" data-id="<?php echo ($d["goods_id"]); ?>">删除</a>
                                </td>
                ...
                <table cellpadding="5" cellspacing="0" width="99%">
                    <tbody><tr>
                            ...
                            <td align="right">
                                ...
                                <?php else: ?>
                                <a href="javascript:void(0)" id="login"><img src="/Public/Home/images/checkout.gif" alt="checkout" /></a><?php endif; ?>
                            </td>
                        </tr>
                    </tbody></table>
            </div>
        ...
        subtotal();
           ...
           $('.del').click(function(){
                ...
                var _this=$(this);
                $.get('<?php echo U("Carts/del");?>',{'id':id},function(data){
                    if(data.status==1){
           ...
           $('.plus').click(function(){
            ...
            function getChange(_this,type){
               ...
               id*_this.parents('tr').find('.money').text(xiaoji)
                ...
                $('.total').text(total);
                 //发送ajax请求
               $.get('<?php echo U("Carts/edit");?>',{'goods_number':id,'goods_id':goods_id},function(data){
