...
<html>
    ...
    <body>
        ...
        <div style="font-size: 13px;margin: 10px 5px">
            <form action="/Admin/Menu/edit/id/28.html" method="post" enctype="multipart/form-data" >
                ...
                <tr>
                    ...
                    <td>
                        <select name="pid">
                            ...
                            <?php if(is_array($datas)): foreach($datas as $key=>$d): ?><option value="<?php echo ($d["id"]); ?>" <?php echo (getChecked($data["id"],$d['id'])); ?>><?php echo str_repeat("&nbsp;",$d['level']*4); echo ($d["menu_name"]); ?></option><?php endforeach; endif; ?>
