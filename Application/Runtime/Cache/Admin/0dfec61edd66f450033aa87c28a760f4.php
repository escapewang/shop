...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo C('CSS_URL');?>User_Login.css" type="text/css" rel="stylesheet" />
        ...
        <div id="user_login">
                                ...
                                <div class="user_main_box">
                                    ...
                                    <ul>
                                        ...
                                        <li class="user_main_input">
                                            ...
                                            <img src="<?php echo U('login/verify');?>" onclick="aa()" id="verify" alt="" />
                                        </li>
                                    </ul>
                                </div>
                            </li>
            ...
            verify.src="/Admin/Login/verify/t="+Math.random();
                    }
                </script>
                                <input style="border: medium none; background: url('<?php echo C('IMG_URL');?>user_botton.gif') repeat-x scroll left top transparent; height: 122px; width: 111px; display: block; cursor: pointer;" value="" type="submit">
                            </li>
                        </ul>
                    </form>
