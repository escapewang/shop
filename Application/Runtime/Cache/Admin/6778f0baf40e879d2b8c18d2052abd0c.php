...
<html>
    <head>
        ...
        <link href="<?php echo C('CSS_URL');?>admin.css" type="text/css" rel="stylesheet" />
    ...
    <body>
        <table height="100%" cellspacing=0 cellpadding=0 width=170 
               background="<?php echo C('IMG_URL');?>/menu_bg.jpg" border=0>
               <tr>
                <td valign=top align=middle>
                   ...
                   <?php if(is_array($datas)): foreach($datas as $key=>$d): ?><table cellspacing=0 cellpadding=0 width=150 border=0>
                        <tr height=22>
                            <td style="padding-left: 30px" background="<?php echo C('IMG_URL');?>/menu_bt.jpg"><a 
                    ...
                    <table id="child<?php echo ($d["id"]); ?>" style="display: none" cellspacing=0 cellpadding=0 
                           ...
                           <?php if(is_array($d["_child"])): foreach($d["_child"] as $key=>$dd): ?><tr height=20>
                            <td align=middle width=30><img height=9 
                                                           src="<?php echo C('IMG_URL');?>menu_icon.gif" width=9></td>
